        ...
        for result in results.xyxy[0]:
            if result[5] == 0:  # 클래스 인덱스가 0일 때(사람 얼굴을 의미하는 클래스)
                ...
                for image_path in image_paths:
                    ...
                    similarity = DeepFace.verify(image, "output_image.jpg", model_name = 'Facenet512', enforce_detection=False )
...
if __name__ == "__main__":
    ...
    image_paths = ["train/Gongyoo/image1.png", "train/Gongyoo/image2.png", "train/Gongyoo/image3.png"]
