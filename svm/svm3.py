...
# 데이터 합치기 불필요 - 단일 데이터셋 사용
features = np.vstack(wider_features)
labels = np.hstack(wider_labels)
print('데이터 합치기 끝')
...
# 모델 저장
joblib.dump(grid_search.best_estimator_, 'svm_wider_face_recognition.pkl')
